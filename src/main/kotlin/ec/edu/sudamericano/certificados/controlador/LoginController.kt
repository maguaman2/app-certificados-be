...
import ec.edu.sudamericano.certificados.dto.AuthenticationRequest
import ec.edu.sudamericano.certificados.dto.AuthenticationResponse
import ec.edu.sudamericano.certificados.security.JwtUtil
...
class LoginController {
    ...
    fun createToken(@RequestBody request: AuthenticationRequest): ResponseEntity<AuthenticationResponse> {
        try {
            ...
            val userDetails: UserDetails = certUserDetailsService.loadUserByUsername(request.username)
